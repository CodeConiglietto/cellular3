...
impl Node for NoiseNodes {
    ...
    fn compute(&self, state: UpdateState) -> Self::Output {
        ...
        match self {
            BasicMultiFractalNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
            ...
            CheckerboardNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
            ...
            FractalBrownianNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
            ...
            HybridMultiFractalNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
            ...
            OpenSimplexNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
            ...
            RidgedMultiFractalNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
            ...
            SuperSimplexNoise { noise } => SNFloat::new(
                noise
                    .noise
                    .get([
                        state.coordinate_set.x.into_inner() as f64
